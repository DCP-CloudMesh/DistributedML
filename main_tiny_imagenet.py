...
from dataloader.tinyimagenet_dataset import ParquetDataset
...
def main():
    ...
    test_dataset = ParquetDataset(test_data, transform=transform)
    ...
    if model_name == "SimpleCNN":
        base_model = SimpleCNN(200).to(device_name)
